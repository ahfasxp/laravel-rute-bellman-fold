                    ...
                    <form style="margin-top: 1.5rem" method="POST" action="{{ route('login') }}">
                        ...
                        <div style="margin-bottom: 1.75rem">
                            ...
                            <div class="d-flex w-100 div-input">
                                ...
                                <input class="input-field border-0 @error('email') is-invalid @enderror" type="email"
                        ...
                        <div style="margin-top: 1rem">
                            ...
                            <div class="d-flex w-100 div-input">
                                ...
                                <input class="input-field border-0 @error('password') is-invalid @enderror"
                                    type="password" name="password" id="password-content-3-5"
                        ...
                        @if (Route::has('password.request'))
                            <div class="d-flex justify-content-end" style="margin-top: 0.75rem">
                                <a href="{{ route('password.request') }}" class="forgot-password fst-italic">Forgot
                                    Password?</a>
                            </div>
                        @endif
